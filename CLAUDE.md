...
_Generated by `tools/gen-code-map.py` from `src/` (155 source files). Do not edit by hand — re-run the script._
...
### Self-test blocks (14 blocks, 189 suites)
...
**(unlabelled suites at line 33383)** — `src/app/js/0600-v2-2-self-test-suites-report-design-markdown/` (17 files)
...
**(unlabelled suites at line 38546)** — `src/app/js/0610-suites-paths-and-the-driver-contract-tf-2/` (3 files)
