...
_Generated by `tools/gen-code-map.py` from `src/` (157 source files). Do not edit by hand — re-run the script._
...
### Self-test blocks (15 blocks, 190 suites)
...
**PHASE-7 SELF-TEST SUITES (report · generate · determinism)** — `src/app/js/0510-phase-7-self-test-suites-report-generate-det/` (4 files)
...
**(unlabelled suites at line 33424)** — `src/doc/js/0900-doc-suites/020-blocks.js`

- _the block helpers (BLK-1)_
  - `line 11` BLK-1 ordering and wording are the module’s, not the host’s

**(unlabelled suites at line 33487)** — `src/app/js/0600-v2-2-self-test-suites-report-design-markdown/` (17 files)
...
**(unlabelled suites at line 38650)** — `src/app/js/0610-suites-paths-and-the-driver-contract-tf-2/` (3 files)
