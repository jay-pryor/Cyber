...
_Generated by `tools/gen-code-map.py` from `src/` (163 source files). Do not edit by hand — re-run the script._
...
### Self-test blocks (15 blocks, 194 suites)
...
**(unlabelled suites at line 34026)** — `src/doc/js/0900-doc-suites/020-blocks.js`

- _the block helpers (BLK-1)_
  - `line 11` BLK-1 ordering and wording are the module’s, not the host’s

**(unlabelled suites at line 34089)** — `src/app/js/0600-v2-2-self-test-suites-report-design-markdown/` (17 files)
...
**(unlabelled suites at line 39253)** — `src/app/js/0610-suites-paths-and-the-driver-contract-tf-2/` (3 files)
