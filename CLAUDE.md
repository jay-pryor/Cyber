...
_Generated by `tools/gen-code-map.py` from `src/` (153 source files). Do not edit by hand — re-run the script._
...
### Self-test blocks (13 blocks, 188 suites)
...
**(unlabelled suites at line 38426)** — `src/app/js/0610-suites-paths-and-the-driver-contract-tf-2/` (3 files)
