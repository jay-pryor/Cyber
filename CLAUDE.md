...
**PHASE-7 SELF-TEST SUITES (report · generate · determinism)** — `src/app/js/0510-phase-7-self-test-suites-report-generate-det/` (3 files)
...
**v2.2 SELF-TEST SUITES (Report Design: markdown · outline · templates)** — `src/app/js/0600-v2-2-self-test-suites-report-design-markdown/` (17 files)
...
**(unlabelled suites at line 38386)** — `src/app/js/0610-suites-paths-and-the-driver-contract-tf-2/` (3 files)
