...
_Generated by `tools/gen-code-map.py` from `src/` (152 source files). Do not edit by hand — re-run the script._
...
### Self-test blocks (13 blocks, 187 suites)
...
**PHASE-7 SELF-TEST SUITES (report · generate · determinism)** — `src/js/0510-phase-7-self-test-suites-report-generate-det/` (3 files)
...
**(unlabelled suites at line 38386)** — `src/js/0610-suites-paths-and-the-driver-contract-tf-2/` (3 files)
