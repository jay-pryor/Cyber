...
| `src/app/js/0350-generate/` (5 files) | **App.generate** | Orchestrate the three INDEPENDENT generators (spec §7, §10): gather a device's applicable+complete items per dataset, call adapter generators + platf… |
...
**(unlabelled suites at line 34202)** — `src/doc/js/0900-doc-suites/020-blocks.js`

- _the block helpers (BLK-1)_
  - `line 11` BLK-1 ordering and wording are the module’s, not the host’s

**(unlabelled suites at line 34265)** — `src/doc/js/0900-doc-suites/030-host-object.js`

- _the host contract (HOSTOBJ-1)_
  - `line 10` HOSTOBJ-1 the module is driven by an explicit host object

**(unlabelled suites at line 34342)** — `src/app/js/0600-v2-2-self-test-suites-report-design-markdown/` (17 files)
...
**(unlabelled suites at line 39506)** — `src/app/js/0610-suites-paths-and-the-driver-contract-tf-2/` (3 files)
